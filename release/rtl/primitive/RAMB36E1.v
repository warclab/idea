// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/verunilibs/data/blanc/RAMB36E1.v,v 1.30 2011/03/21 07:52:53 wloo Exp $
///////////////////////////////////////////////////////////////////////////////
...
/******************************************** END task and function **************************************/    
	...
	case (WRITE_MODE_A)
	    ...
	    default       : begin
				$display("Attribute Syntax Error : The Attribute WRITE_MODE_A on RB36_INTERNAL_VLOG instance %m is set to %s.  Legal values for this attribute are WRITE_FIRST, READ_FIRST or NO_CHANGE.", WRITE_MODE_A);
				finish_error = 1;
			    end
	endcase
	...
	case (WRITE_MODE_B)
	    ...
	    default       : begin
				$display("Attribute Syntax Error : The Attribute WRITE_MODE_B on RB36_INTERNAL_VLOG instance %m is set to %s.  Legal values for this attribute are WRITE_FIRST, READ_FIRST or NO_CHANGE.", WRITE_MODE_B);
				finish_error = 1;
			    end
	endcase
	...
	case (RAM_EXTENSION_A)
	    ...
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute RAM_EXTENSION_A on RB36_INTERNAL_VLOG instance %m is set to %s.  Legal values for this attribute are LOWER, NONE or UPPER.", RAM_EXTENSION_A);
		          finish_error = 1;
		      end
	endcase
	...
	case (RAM_EXTENSION_B)
	    ...
	    default : begin
	       	          $display("Attribute Syntax Error : The attribute RAM_EXTENSION_B on RB36_INTERNAL_VLOG instance %m is set to %s.  Legal values for this attribute are LOWER, NONE or UPPER.", RAM_EXTENSION_B);
		          finish_error = 1;
		      end
	endcase
	...
	if ((SIM_COLLISION_CHECK != "ALL") && (SIM_COLLISION_CHECK != "NONE") && (SIM_COLLISION_CHECK != "WARNING_ONLY") && (SIM_COLLISION_CHECK != "GENERATE_X_ONLY")) begin
	    ...
	    $display("Attribute Syntax Error : The attribute SIM_COLLISION_CHECK on RB36_INTERNAL_VLOG instance %m is set to %s.  Legal values for this attribute are ALL, NONE, WARNING_ONLY or GENERATE_X_ONLY.", SIM_COLLISION_CHECK);
	    finish_error = 1;
