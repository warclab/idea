...
int main () {
  ...
  // changed
  6c: 10a20009  beq a1,v0,84 <main+0x94>
  ...
  80: 88888888  mac a0,t4,t3
    ...
    for (n = 0; n < ndata; n++) {
        sum = 0;
        for (k = 0; k < ncoeff; k++) {
  8c: 14a2fff9  bne a1,v0,6c <main+0x74>
...
int main () {
 ...
 // Manually inserted by Fred, Apr. 4 2013
  ...
  // Changed
  d4: 1467fff8  bne v1,a3,a8 <main+0xb8>
