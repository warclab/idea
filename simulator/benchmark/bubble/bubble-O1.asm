...
int main()
  ...
  54:	08000025 	j	94 <main+0x94>
  58:	27a600c4 	addiu	a2,sp,196
...
START_CCORE
  ...
  60:	8c440004 	lw	a0,4(v0)
  64:	00000000 	sll	zero,zero,0x0
  68:	0083282b 	sltu	a1,a0,v1
  6c:	10a00003 	beqz	a1,7c <main+0x7c>
  70:	00000000 	sll	zero,zero,0x0
          {
            swap       = array[d];
            array[d]   = array[d+1];
  74:	ac440000 	sw	a0,0(v0)
            array[d+1] = swap;
  78:	ac430004 	sw	v1,4(v0)
  7c:	24420004 	addiu	v0,v0,4
    ...
    for (c = 0 ; c < ( n - 1 ); c++)
      {
        for (d = 0 ; d < n - c - 1; d++)
  80:	14c2fff6 	bne	a2,v0,5c <main+0x5c>
  84:	00000000 	sll	zero,zero,0x0
  88:	24c6fffc 	addiu	a2,a2,-4
    ...
    for (c = 0 ; c < ( n - 1 ); c++)
  8c:	10c70003 	beq	a2,a3,9c <main+0x9c>
  90:	00001821 	addu	v1,zero,zero
  94:	08000020 	j	80 <main+0x80>
  98:	03a01021 	addu	v0,sp,zero
